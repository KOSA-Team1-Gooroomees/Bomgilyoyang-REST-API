                        ...
                        <form id="signupForm" th:action="@{/signup}" th:method="post" th:object="${registerRequest}">
                            <div class="relative mb-3">
                                ...
                                <input type="text" name="name" placeholder="이름을 입력하세요"
                                    class="w-full pl-11 pr-4 py-3.5 border border-gray-200 rounded-xl focus:outline-none focus:border-brand-green focus:ring-1 focus:ring-brand-green text-sm text-gray-700 placeholder-gray-400 bg-gray-50/50"
                                    required />
                            </div>
                            ...
                            <div class="relative mb-3">
                                ...
                                <input type="email" name="email" id="email" placeholder="이메일을 입력하세요"
                                    class="w-full pl-11 pr-32 py-3.5 border border-gray-200 rounded-xl focus:outline-none focus:border-brand-green focus:ring-1 focus:ring-brand-green text-sm text-gray-700 placeholder-gray-400 bg-gray-50/50"
                                    required />
                                <button type="button" id="checkEmailBtn"
                                    class="absolute inset-y-1.5 right-1.5 px-3 bg-brand-green hover:bg-brand-greenHover text-white text-xs font-semibold rounded-lg transition-colors duration-200"
                            ...
                            <div class="relative mb-3">
                                ...
                                <input type="password" name="password" id="password" placeholder="비밀번호를 입력하세요"
                                    class="w-full pl-11 pr-11 py-3.5 border border-gray-200 rounded-xl focus:outline-none focus:border-brand-green focus:ring-1 focus:ring-brand-green text-sm text-gray-700 placeholder-gray-400 bg-gray-50/50"
